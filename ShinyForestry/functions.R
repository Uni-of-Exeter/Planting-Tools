...
calories_livestock_arable<- function(shapefile, yield_data, matched_data_sf, FullTable) {
 ...
 #FullTable<- calories_livestock_arable(shapefile= sf::st_read("C:/Users/mh1176/University of Exeter/Mancini, Mattia - PCSE-WOFOST/ParcelData/land_parcels.shp"), # change this to your shapefile
                                         #yield_data = yield_data,matched_data_sf=sf::st_read("df_livestock.geojson"), #you need upload livestock data
