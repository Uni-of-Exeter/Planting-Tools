...
map_and_slider_ui_sample <- function(id, year_min, year_max, year_default, show_time_series = TRUE, panel_width = "37.5%") { # 37.5% is defined by (9/12) width in bootstrap * 50% 
  ns <- NS(id)  # Namespace all IDs properly
